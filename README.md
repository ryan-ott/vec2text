...
Please refer to the `vec2text/reproduction` directory for our files regarding the reproduction of the original claims by Morris et al. There you will also find our `reproductionREADME.md` with examples of how to run the code (same as below).
